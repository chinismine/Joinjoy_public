...
public class LinePayService {
	...
	public LinePayInfo convertLinepayInfo(List<SignUpDTO> signDTOs,HttpServletRequest request) {
        ...
        if(request.getServerName().equals("localhost")) {
        	...
        	redirectUrls.setConfirmUrl("http://localhost:8081/signSuccess/"+signDTOs.get(0).getAcid());
        	redirectUrls.setCancelUrl("http://localhost:8081/payFailed/"+signDTOs.get(0).getAcid());
        }else {
